...
function themNhanVien() {
  ...
  isValid&=validation.KiemTraRong("msnv","tbMaNV","(*) Vui long nhap ma");
   isValid&=
   validation.KiemTraDinhDangChu("name","tbTen","(*) Vui long dung ki tu")&
   validation.KiemTraDinhDangEmail("email","tbEmail","(*) Vui long dung ki tu");
  // isValid=validation.KiemTraDinhDangEmail("password","tbMatKhau","(*) Vui long dung ki tu");
